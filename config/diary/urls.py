...
from .views import DiaryCreateView, DiaryDetailView, MonthDiaryListView,  EmojRatioView, EmojCalendarDiaryView, CheckTodayDiaryView
...
urlpatterns = [
    ...
    path('emoj/calendar/', EmojCalendarDiaryView.as_view(), name='diary_emoj_calendar'),
